...
def is_superbalanced(tree, node=None):
    '''a tree is considered superbalanced if the difference in height of
    ...
    superbalanced, a boolean is only returned on the first iteration
    or when the tree is not superbalanced, False. Otherwise the height
    ...
    if node.left is not None:
        ...
        left_height = is_superbalanced(tree, node.left)
    ...
    if node.right is not None:
        ...
        right_height = is_superbalanced(tree, node.right)
